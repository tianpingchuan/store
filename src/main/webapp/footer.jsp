	...
	<div class="footer">
		<div class="footer_agile_inner_info_w3l">
			<div class="col-md-3 footer-left">
				<h2>
					<a href="page/index"><span>E</span>lite Shoppy </a>
				</h2>
			...
			<div class="col-md-9 footer-right">
				<div class="sign-grds">
					...
					<div class="col-md-3 sign-gd flickr-post">
						...
						<ul>
							<li><a href="single"><img
									src="assert/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
							<li><a href="single"><img
									src="assert/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
							<li><a href="single"><img
									src="assert/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
							<li><a href="single"><img
									src="assert/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
							<li><a href="single"><img
									src="assert/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
							<li><a href="single"><img
									src="assert/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
...
<!-- js -->
<script type="text/javascript" src="assert/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<script src="assert/js/responsiveslides.min.js"></script>
				<script>
...
<script src="assert/js/modernizr.custom.js"></script>
...
if (~window.location.search.indexOf('reset=true')) {
	...
	<!---->
						...
						<script type="text/javascript" src="assert/js/jquery-ui.js"></script>
					 <!---->
<!-- start-smoth-scrolling -->
<script type="text/javascript" src="assert/js/move-top.js"></script>
<script type="text/javascript" src="assert/js/jquery.easing.min.js"></script>
