		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="assert/images/banner2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="assert/images/banner5.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="assert/images/banner2.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="assert/images/bb2.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Party Men's Blazer</a></h4>
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Analog Watch</a></h4>
										<div class="info-product-price">
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="assert/images/s1.jpg" alt="" class="pro-image-front">
										<img src="assert/images/s1.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single" class="link-product-add-cart">Quick View</a>
												</div>
		...
		<div class="single-pro">
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Formal Blue Shirt</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Gabi Full Sleeve Sweatshirt</a></h4>
										<div class="info-product-price">
											<span class="item_price">$45.99</span>
											<del>$69.71</del>
										</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Dark Blue Track Pants</a></h4>
										<div class="info-product-price">
											<span class="item_price">$80.99</span>
											<del>$89.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Round Neck Black T-Shirt</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Men's Black Jeans</a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="single">Reversible Belt</a></h4>
										<div class="info-product-price">
