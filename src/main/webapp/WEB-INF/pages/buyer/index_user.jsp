		...
		<div class="banner_bottom_agile_info_inner_w3ls">
			<div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
				<figure class="effect-roxy">
					<img src="assert/images/bottom1.jpg" alt=" " class="img-responsive" />
					<figcaption>
						<h3>
							<span>F</span>引领未来
						</h3>
			...
			<div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
				<figure class="effect-roxy">
					<img src="assert/images/bottom2.jpg" alt=" " class="img-responsive" />
					<figcaption>
						<h3>
							<span>F</span>引领未来
						</h3>
				...
				<c:if test="${!empty catalogChildList}">
					<c:forEach items="${catalogChildList}" var="Catalog">
						<div class="tab1">
							...
							<c:if test="${!empty Catalog.productList}">
