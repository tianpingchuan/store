...
<body id="page-top">
	<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
		<a class="navbar-brand mr-1" href="user/gopersonal">个人中心</a>
		...
		<form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
			<div class="input-group">
				<a class="navbar-brand mr-1" href="index">商城首页</a>
			</div>
		</form>
		...
		<ul class="navbar-nav ml-auto ml-md-0">
			...
			<li class="nav-item dropdown no-arrow mx-1"><a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-envelope fa-fw"></i>
				...
				<li>
					<button>欢迎：${userBuyer.userName}</button>
				</li>
				</c:if>
				<li>
					<a class="dropdown-item" href="user/loginoutbuyer">退出登录</a>
				</li>
